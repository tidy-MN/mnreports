...
output:
  mnreports::html_document:
    ...
    df_print: paged
    includes:
      before_body: resources/mdh_banner_white.html #More options: mdh_banner_blue.html
...
ggplot(drug_prices, aes(x = date, y = bill_length_mm)) +
  ...
  scale_color_manual(values = mncolors(7, "primary_accent")[1:3],
  ...
  theme(legend.position = c(0.85, 0.22),
        plot.title = element_text(color = mncolors(5, "blue")[5],
                                  size = 18,
                                  family = "Arial Narrow"),
